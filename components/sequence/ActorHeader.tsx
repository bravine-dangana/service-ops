...
export function ActorHeader({ actor }: { actor: SequenceActor }) {
  ...
  return (
    <div
      className="flex w-[130px] items-center justify-center gap-1.5 rounded-md border-2 border-black px-2 py-2 text-center text-[11px] font-semibold leading-snug text-white shadow-sm"
